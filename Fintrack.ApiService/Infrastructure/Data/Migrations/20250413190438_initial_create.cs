    ...
    public partial class initial_create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ak_currency_codes_code", x => x.code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    account_currency = table.Column<string>(type: "character varying(3)", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_accounts_currency_codes_currency",
                        column: x => x.account_currency,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    transaction_currency = table.Column<string>(type: "character varying(3)", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_transactions_accounts_origin_account_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_transactions_currency_codes_currency",
                        column: x => x.transaction_currency,
                        principalTable: "currency_codes",
                        principalColumn: "code",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_transactions_origin_account_id",
                table: "transactions",
